...
const targetTheme = theme => {
  switch (theme) {
    case 'dark':
      return _stitches__WEBPACK_IMPORTED_MODULE_1__.darkTheme;
      break;
  }
};
Primary.parameters = {
...
targetTheme.parameters = {
  ...targetTheme.parameters,
  docs: {
    ...targetTheme.parameters?.docs,
    source: {
      originalSource: "(theme: string) => {\n  switch (theme) {\n    case 'dark':\n      return darkTheme;\n      break;\n  }\n}",
      ...targetTheme.parameters?.docs?.source
    }
  }
};
const __namedExportsOrder = ["Primary", "Secondary", "targetTheme"];
